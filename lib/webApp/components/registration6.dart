...
class _Registration6State extends State<Registration6> {
  ...
  final Map<String, String> _validBanks = {
    "GOLOMT": "Absa Bank",
    "Golomt": "Capitec Bank",
    "golomt": "First National Bank",
    "GOLOMT BANK": "Investec Bank",
    "Golomt BANK": "Nedbank",
    "golomt BANK": "Standard Bank",
    "GOLOMT bank": "African Bank",
    "Golomt bank": "Bidvest Bank",
    "golomt bank": "Discovery Bank",
    "TYMEBANK": "TymeBank",
