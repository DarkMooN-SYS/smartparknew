                                                    ...
                                                    showDialog(
                                                      ...
                                                      builder: (BuildContext
                                                        ...
                                                        return AlertDialog(
                                                          backgroundColor:
                                                              const Color(
                                                                  0xFF35344A), // Change dialog background color
                                                          title: const Text(
                                                            'Confirm',
                                                            style: TextStyle(
                                                                color: Colors
                                                          ...
                                                          actions: <Widget>[
                                                            TextButton(
                                                              child: const Text(
                                                                ...
                                                                style: TextStyle(
                                                                    color: Color(
                                                                        0xFF58C6A9)), // Change button text color
                                                              ),
                                                              onPressed: () {
                                                                Navigator.of(
                                                                        context)
                                                            ...
                                                            TextButton(
                                                              ...
                                                              onPressed: () {
                                                                Navigator.of(
                                                                        context)
                                                                    .pop(
                                                                        true); // Close the confirmation dialog
                                                                showDialog(
                                                                  context:
                                                                      context,
                                                                  builder:
                                              ...
                                              backgroundColor:
                                                ...
                                                (Set<WidgetState> states) {
                                                  if (states.contains(
                                                    ...
                                                    return const Color(
                                                        0xFF58C6A9); // Light blue when disabled
                                                  }
                                                  return const Color(
                                                      0xFF58C6A9); // Light blue when enabled
                                                },
                                              ),
                                            ),
                                            child: Text(
                                                                    ...
                                                                    Center(
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          'OK',
                                                                          style:
                                                                              TextStyle(color: Color(0xFF58C6A9)), // Change button text color
                                                                        ),
                                                                        onPressed:
                                                                            () {
                                                                          Navigator.of(context)
                                                                              .pop(true); // Close the success dialog
                                                                          setState(
                                                                              () {
                                                                            _appliedCouponIndices.remove(index);
                                                                            coupons[index]['applied'] =
                                                                                false;
                                                                          });
                                                                          // Update Firestore
                                                                          FirebaseFirestore
